...
## lesson-6
### Python Formatted String also known as F-string is an easier and convenient way to dynamically generate contents. It helps python coder to get rid of the cumbersome expression of concatenation.
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss6.PNG?raw=true)

## lesson-7
### Along with String Methods, this lesson covers the difference between function and method. It also explains how to use 'dot operator' to access the methods in python.

![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss7.PNG?raw=true)

## lesson-8
### These are actually the basic mathematical operations. This lesson covers the syntax and expression of basic python arithmetic operations.

![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss8.PNG?raw=true)

## lesson-9
### The math module can be imported by typing import math, which provides access to additional functions like ceil(),round(),floor() etc...
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss9.PNG?raw=true)

## lesson-10
### If/elsee statements allow programs to make decisions based on conditions.
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss10.PNG?raw=true)

## lesson-11
### The capability of 'if statement' goes to the next level when we use logical operator in it. As a matter of fact, there are many complex logics and conditions which are not possible without combining logical operators with 'if statements'.
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss11.PNG?raw=true)

## lesson-12
### The lesson discusses the use of comparison operators in Python, explaining that comparisons between variable values and other values are common in programming, such as checking the price of a product.
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss12.PNG?raw=true)

## lesson-13
### While loop is used to repeatedly execute a block of code while a condition remains true.
![image alt](https://github.com/nahian-tech-master/python_lab_1/blob/main/pyhon%20lab%201/ss13.PNG?raw=true)

## lesson-14
### Using while loop to finding a product price.
